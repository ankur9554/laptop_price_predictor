...
IMAGE_PATH = os.path.join(dir_of_interest, "images", "visu.jpg")
...
fig1.update_layout(template=draft_template, paper_bgcolor="white",
...
fig2 = go.Figure(
    data=[go.Pie(labels=total_freq.index, values=total_freq, pull=[0, 0.2], hole=0.3, title="<b>  </b>")])
fig2.update_traces(textposition="inside", textinfo="percent+label")
fig2.update_layout(paper_bgcolor="white", title="<b> Total Brands Processor Wise(TOP 10)")
fig2.update_layout(
    font_color="black",
    title_font_color="black",
    legend_title_font_color="black"
...
fig3.update_layout(template=draft_template, paper_bgcolor="white",
                   title="<b> Avarage Price RAM wise of All Brans")
fig3.update_layout(
    font_color="black",
    title_font_color="black",
    legend_title_font_color="black"
...
fig4.update_layout(template=draft_template, paper_bgcolor="white",
